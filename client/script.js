...
function loader(element) {
  ...
  loadInterval = setInterval(() => {
    // Actualizar el contenido del texto del indicador de carga.
    element.textContent += ".";
...
// generar una identificación única para cada div de mensaje del bot
// necesario para escribir el efecto de texto para esa respuesta específica
// sin una identificación única, escribir texto funcionará en cada elemento
...
const handleSubmit = async (e) => {
  ...
  // para enfocar, desplácese hacia abajo
